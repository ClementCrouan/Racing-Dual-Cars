...
public class GraphOverlay : MonoBehaviour
{
	...
	public Vector2 graphPositionTexte;
	public Vector2 graphPositionImage;
	[Range(0f, 10f)]
	...
	void Start()
	{
		...
		if (numeroDeCamera == 0)
		{
			imageXform.anchorMin = new Vector2(0.5f, 1);
			imageXform.anchorMax = new Vector2(0.5f, 1);
		}

		if (numeroDeCamera == 1)
		{
			imageXform.anchorMin = new Vector2(0, 1);
			imageXform.anchorMax = new Vector2(0, 1);
		}

		imageXform.pivot = Vector2.up;
        imageXform.anchoredPosition = new Vector2(graphPositionImage.x, graphPositionImage.y);
		...
		if(numeroDeCamera == 0)
        {
			textXform.anchorMin = new Vector2(0.5f, 1);
			textXform.anchorMax = new Vector2(0.5f, 1);
		}

		if (numeroDeCamera == 1)
		{
			textXform.anchorMin = new Vector2(0, 1);
			textXform.anchorMax = new Vector2(0, 1);
		}

		textXform.pivot = Vector2.up;
        textXform.anchoredPosition = new Vector2(graphPositionTexte.x, graphPositionTexte.y);
