...
public class GraphOverlayEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        myTarget.numeroDeCamera = (int)EditorGUILayout.Slider("Numero De Camera", myTarget.numeroDeCamera, 0, 1);
        myTarget.graphPositionTexte = EditorGUILayout.Vector2Field("Graph Position Texte", myTarget.graphPositionTexte);
        myTarget.graphPositionImage = EditorGUILayout.Vector2Field("Graph Position Image", myTarget.graphPositionImage);
